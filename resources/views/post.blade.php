                ...
                <div class="main-post">
                    ...
                    <div class="post-icons-area">
                        <ul class="post-icons">
                            <li>
                                @guest
                                    <a href="javascript:void(0);" onclick="toastr.info('To add favorite list. You need to login first.','Info',{
                                        closeButton: true,
                                        progressBar: true,
                                    })"><i class="material-icons">favorite</i>{{ $post->favorite_to_users->count() }}</a>
                                @else
                            ...
                            <li>
                                <a href="#"><i class="material-icons">feedback</i>{{ $post->comments->count() }}</a>
                            </li>
                            <li>
                                <a href="#"><i class="material-icons">remove_red_eye</i>{{ $post->view_count }}</a>
                            </li>
                        </ul>
            ...
            <div class="col-lg-4 col-md-12 no-left-padding">
                ...
                <div class="single-post info-area">
                    ...
                    <div class="sidebar-area about-area">
                        <h4 class="title"><b>ABOUT RESTAURANT</b></h4>
                        <p>{{ $post->user->about}}</p>
                    </div>

                    <div class="tag-area">

                        <h4 class="title"><b>CATEGORY LIST</b></h4>
                        <ul>
                        ...
                        <div class="blog-image"><img src="{{Storage::disk('public')->url('post/'.$randompost->image)}}" alt="{{$randompost->title}}"></div>
                            ...
                            <h4 class="title"><a href="{{ route('post.details', $randompost->slug) }}"><b>{{$randompost->title}}</b></a></h4>
                                ...
                                <ul class="post-footer">
                                    ...
                                    <li>
                                        @guest
                                            <a href="javascript:void(0);" onclick="toastr.info('To add favorite list. You need to login first.','Info',{
                                                closeButton: true,
                                                progressBar: true,
                                            })"><i class="material-icons">favorite</i>{{ $randompost->favorite_to_users->count() }}</a>
                                        @else
                                            <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $post->id }}').submit();"
                                    ...
                                    <li>
                                        <a href="#"><i class="material-icons">feedback</i>{{ $randompost->comments->count() }}</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="material-icons">remove_red_eye</i>{{ $randompost->view_count }}</a>
                                    </li>
                                </ul>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="comment-form">
                    @guest
                        <p>To post a comment, You need to login first. <a href="{{ route("login") }}">Login</a></p>
                    @else
